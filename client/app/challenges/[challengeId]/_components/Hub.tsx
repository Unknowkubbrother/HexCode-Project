        ...
        <Carousel className="w-full">
          <CarouselContent className="-ml-1">
            {Array.from({ length: 10 }).map((_, index) => (
              ...
              >
                <Image src={"https://wallpapershome.com/images/pages/ico_h/27093.jpg"} unoptimized alt="promote" width={100} height={100} className="w-full h-full object-contain rounded-lg" key={index} />
              </CarouselItem>
            ))}
          </CarouselContent>
          <CarouselPrevious />
