...
export default function CreateChallenge() {
    ...
    const [countRewards, setCountRewards] = useState<number>(1);
    ...
    return (
        <main className='w-[70%] m-auto my-10'>
            ...
            <div className='w-full'>
                ...
                <div className="w-full mt-5 flex flex-col justify-start items-start gap-3 pb-5 border-b-2">
                    <div className="flex justify-start items-center gap-1.5">
                        <Label htmlFor="input_testcase">Problems </Label>
                ...
                <div className="w-full mt-5 flex flex-col justify-start items-start gap-3 pb-5 border-b-2">
                    <div className="flex justify-start items-center gap-1.5">
                        <Label htmlFor="input_testcase"><span className="text-primary">Rewards</span> </Label>
                        <Button variant="ghost" size='sm'
                            onClick={() => { setCountRewards(countRewards > 1 ? countRewards - 1 : 1); handlerCountRewards(countRewards > 1 ? countRewards - 1 : 1) }}
                        ><Minus /></Button>
                ...
                <div className="flex flex-col gap-3 mt-5 border-b-2 pb-5">
                    <label htmlFor="description" className="text-sm">Images</label>
            ...
            <div className="w-full mt-5 flex justify-end items-center gap-3">
                <Button variant="default" onClick={createChallenge}>Create Challenge</Button>
            </div>
        </main>
    )
}
