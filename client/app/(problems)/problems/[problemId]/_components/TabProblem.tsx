          ...
          <nav>
            <ul className="flex gap-2 justify-start items-center">
              <li className="px-5 py-2 text-xs bg-background rounded-lg flex flex-col justify-center items-center gap-1">
                ...
                <span className="text-primary">{problemData?.cpu_time_limit || "N/A"} s</span>
              </li>
              <li className="px-5 py-2 text-xs bg-background rounded-lg flex flex-col justify-center items-center gap-1">
                <div className="flex justify-center items-center gap-1">
                  <Database size={13} />
                ...
                <span className="text-primary">{problemData?.memory_limit || "N/A"} MiB</span>
              </li>
              <li className="px-5 py-2 text-xs bg-background rounded-lg flex flex-col justify-center items-center gap-1">
                <div className="flex justify-center items-center gap-1">
                  <Database size={13} />
                ...
                <span className="text-primary">{problemData?.stack_limit || "N/A"} MiB</span>
              </li>
              <li className="px-5 py-2 text-xs bg-background rounded-lg flex flex-col justify-center items-center gap-1">
                <div className="flex justify-center items-center gap-1">
                  <File size={13} />
                ...
                <span className="text-primary">{problemData?.max_file_size || "N/A"} MiB</span>
              </li>
            </ul>
          </nav>
