    ...
    return (
        <div className="w-full h-full relative">
            ...
            {isAciveView && selectedViewsubmission && (
                <div className="absolute top-[65%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 dark:bg-background bg-bgsecondary flex justify-center items-center rounded-xl z-50 border-2">
                            ...
                            <div>
                                ...
                                <div className="w-full flex flex-col gap-5">
                                    ...
                                    <CodeBlock
                                        ...
                                        filename={""}
                                        className="w-[700px] h-[500px] overflow-auto border-[3px]"
                                    />
