...
export default function Navbar({ setTheme }: NavbarProps) {
  ...
  return (
    <nav className="w-full h-[50px] flex justify-around items-center border-b-2 bg-bgprimary py-7 top-0 z-50 sticky backdrop-blur text-navtextcolor bg-background">
